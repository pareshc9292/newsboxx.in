            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                        <h2><i class="fa fa-shopping-cart bg-orange"></i> Shop  <small class="hidden-xs-down hidden-sm-down"> </small></h2>
                    </div><!-- end col -->
            ...
            <div class="row">
                <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="blog-grid-system">
                            <div class="row">
                              ...
                              <?php include "include/db.php";
                                ...
                                $sql = "SELECT * FROM shop ORDER BY shop.m_id DESC LIMIT {$offset},{$limit}";
                    ...
                    if(mysqli_num_rows($result1) > 0)
                    {
                      ...
                      if($page > 1){
                        echo '<li><a class="page-link" href="shop.php?page='.($page - 1).'">Prev</a></li>';
                      }
