<?php require_once "include/header.php" ?>
        <section class="section single-wrapper">
            <div class="container">
                ...
                $g_id = $_GET['id'];
                $query = "select * from gadget WHERE gadget.g_id = {$g_id}";
                ...
                $query="UPDATE `gadget` SET `views`=`views`+ 1 WHERE `g_id`=$g_id "; 
                $data = mysqli_query($con,$query);
                ?>
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            ...
                            <div class="single-post-media">
                                <img src="img/gadget/<?php echo $image ?>" alt="" class="img-fluid">
                            </div><!-- end media -->
